...
function renderizarProdutos() {
    ...
    let listaProdutos = [
        ...
        },
        {
            ...
            imagem: "./img/produtos/mousepad1.jpg",
            descricao: "Esse mousepad é do tipo Speed e possui RGB nas laterais",
            preco: "169,90"
        },
        {
            nome: "Mouse Gamer RGB",
            imagem: "./img/produtos/mouse1.jpg",
            descricao: "Esse mouse tem 10000 dpi, e controle de DPI",
            preco: "159,90"
        },
        {
            nome: "Mouse Gamer Branco",
            imagem: "./img/produtos/mouse2.jpg",
            descricao: "Esse mouse tem 10000 dpi, e controle de DPI",
            preco: "159,90"
        },
        {
            nome: "Kit Gamer Branco",
        ...
        {
            nome: "Cadeira Gamer",
            imagem: "./img/produtos/cadeira.jpg",
            descricao: "Esse mouse tem 10000 dpi, e controle de DPI",
            preco: "1.599,90"
        }        
    ]
